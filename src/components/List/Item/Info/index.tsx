...
const Info = ({ price, oldPrice, title, locality, date, }: IPlace) => {
    ...
    function formatDate() {
        ...
        return `${new String(d.getDate()).padStart(2, '0')}.${new String(d.getMonth() + 1).padStart(2, '0')}.${d.getFullYear()}, ${new String(d.getMinutes()).padStart(2, '0')}:${new String(d.getSeconds()).padStart(2, '0')}`;
